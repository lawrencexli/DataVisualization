...
After the visualizations by state, the fifth visualization aims to display the unemployment rate, labor participation rate, and minimum wage by distributions. For unemployment rate and labor participation rate, I used density plots and histograms. For minimum wage, I used counting distributions because minimum wage is generally decided by state or federal government, which is not a fully dependent variable.
