...
s1 <- ggplot(data_big, aes(x = actualminimumwage2020dollars, 
...
usg = plot_usmap(data = data, values = "percentunemploymentrate", 
                 color = "black") + 
...
data_2000 = data_big[data_big$year == 2000, ]
data_2008 = data_big[data_big$year == 2008, ]
data_2015 = data_big[data_big$year == 2015, ]
data_2020 = data_big[data_big$year == 2020, ]

data_selected = rbind(data_2015, data_2000, data_2008, data_2020)

p <- ggplot(data_selected, aes(x = Percent.Unemployment.Rate)) +
